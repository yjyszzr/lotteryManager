...
Dialog.prototype.close = function() {
    ...
    topWin.Dialog._maskArray[topWin.Dialog._maskArray.length - 1].remove();
	removeWinArray(topWin.Dialog._maskArray, topWin.Dialog._maskArray[topWin.Dialog._maskArray.length - 1]);
    /*if (topWin.Dialog._dialogArray.length > 0) {
        if (this.Modal) {
            Dialog.bgDiv.style.zIndex=topWin.Dialog._dialogArray[topWin.Dialog._dialogArray.length-1].getDialogDiv().style.zIndex-1;
...
Dialog.prototype.getBgdiv = function() {
    ...
    /*if (Dialog.bgDiv) {
        if (this.Modal) {
            document.getElementById("_DialogBGMask" + id).style.opacity = g;
            document.getElementById("_DialogBGMask" + id).style.filter = "alpha(opacity=" + h + ")";
            document.getElementById("_DialogBGMask" + id).style.backgroundColor = this.Bgcolor
        }
        return Dialog.bgDiv
    }*/
    var d = topWin.$id("_DialogBGDiv_" + id);
    /*if (!d) {*/
        d = topDoc.createElement("div");
        d.id = "_DialogBGDiv_" + id;
        if(topWin.Dialog._dialogArray.length == 0){
        	d.style.cssText = "position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:900";
        }else{
        	d.style.cssText = "position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:"+(parseInt(topWin.Dialog._dialogArray[topWin.Dialog._dialogArray.length - 1].zindex) + 1);
        }
        var a = '<div style="position:relative;width:100%;height:100%;">';
        var c = '<div id="_DialogBGMask_' + id + '" style="position:absolute;width:100%;height:100%;"></div>';
        ...
        document.getElementById("_DialogBGMask_" + id).style.opacity = g;
        document.getElementById("_DialogBGMask_" + id).style.filter = "alpha(opacity=" + h + ")";
        document.getElementById("_DialogBGMask_" + id).style.backgroundColor = this.Bgcolor;
        if (ielt7) {
