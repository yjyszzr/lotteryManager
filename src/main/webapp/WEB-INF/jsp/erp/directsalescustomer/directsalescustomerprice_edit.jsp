					...
					<form action="directsalescustomer/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="customer_name" id="customer_name" value="${pd.customer_name}" readonly="readonly" maxlength="50" placeholder="这里输入客户名称" title="客户名称" style="width:98%;"/>
								</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">消费金额:</td>
								<td><input type="number" name="amount" id="amount" value="${pd.amount}" maxlength="20" placeholder="这里输入消费金额" title="消费金额" style="width:98%;"/></td>
							</tr>
