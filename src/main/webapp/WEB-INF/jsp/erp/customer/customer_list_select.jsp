...
<!-- 									<th class="center">状态</th>
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
												    <a class="btn btn-mini btn-success" onclick="selectOpt('${var.customer_id}','${var.customer_name}')">选择客户</a>
												</div>
	...
	<script type="text/javascript">
		...
		function selectOpt(Id,name){
			top.frames[top.frames.length-2].closeFromStormSnDiag(Id,name);
		}
