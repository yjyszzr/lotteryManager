			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="queryotheroutstorage/list.do" method="post" name="Form" id="Form">
 ...
 -->									
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">
												...
												<a class="btn btn-xs btn-success" onclick="detail('${var.other_outstorage_code}');">
														明细详情
													</a>
													<a class="btn btn-xs btn-success" onclick="bound('${var.other_outstorage_code}');">
														仓库记录
													</a>
												</div>
	...
	<script type="text/javascript">
		...
		function detail(code){
			 ...
			 diag.Drag=true;
			 diag.Title ="其他出库详情";
		    diag.URL = '<%=basePath%>queryotheroutstorage/detail.do?other_outstorage_code='+code;
		...
		function bound(sn){
			 ...
			 diag.Drag=true;
			 diag.Title ="出入库记录";
			 diag.URL = '<%=basePath%>queryallocation/bound.do?querytype=other_outstorage_code&purchase_code='+sn;
			 diag.Width = 1250;
			 diag.Height = 755;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
