...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="goodssku/listAllocation.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
												    <a class="btn btn-mini btn-success" onclick="select('${var.sku_id}','${var.sku_name}','${var.sku_encode }','${var.sku_barcode}','${var.unit_name}','${var.spec}','${var.isopen_batch}','${var.attr_cate}','${var.tax_rate}')">选择商品</a>
												</div>
	...
	<script type="text/javascript">
		...
		function select(Id,name, encode, barcode, unit, spec, isopenBatch, attrCate, taxRate){
			top.frames[2].closeSelectAllocationDetailSkuDiag(Id,name, encode, barcode, unit, spec, isopenBatch, attrCate, taxRate);
		}
	</script>
</body>
</html>