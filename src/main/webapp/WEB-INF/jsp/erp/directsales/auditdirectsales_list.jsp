			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="directsales/auditlist.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<td class="center">
												...
												<c:if test="${var.status == '3' }">
														<a class="btn btn-xs btn-success" onclick="update('${var.direct_sales_code}','4')">通过</a>
														<a class="btn btn-xs btn-success" onclick="update('${var.direct_sales_code}','8')">驳回</a>
												</c:if>
												<c:if test="${var.status != '3' }">
														<a class="btn btn-xs btn-success" disabled = "ture" onclick="update('${var.direct_sales_code}','4')">通过</a>
														<a class="btn btn-xs btn-success" disabled = "ture" onclick="update('${var.direct_sales_code}','8')">驳回</a>
												</c:if>
