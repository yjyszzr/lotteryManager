			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="defectivegoodsdetail/listByCode.do" method="post" name="Form" id="Form">
...
<%-- 						<table style="margin-top:5px;">
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>defectivegoodsdetail/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 355;
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>defectivegoodsdetail/goEdit.do?defective_detail_id='+Id;
			 diag.Width = 450;
			 diag.Height = 355;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
