		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="deliveryusercompany/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">标准单数:</td>
								<td><input type="number" name="standard_quantity" id="standard_quantity" value="${pd.standard_quantity}" maxlength="9" placeholder="这里输入标准单数" title="标准单数" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">标准单数外金额:</td>
								<td><input type="number" name="out_amount" id="out_amount" value="${pd.out_amount}" maxlength="9" placeholder="这里输入标准单数外金额" title="标准单数外金额" style="width:98%;"/></td>
							</tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function save(){
			...
			if($("#standard_quantity").val()==""){
				$("#standard_quantity").tips({
					side:3,
		            msg:'请输入标准单数',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#standard_quantity").focus();
			return false;
			}else if(parseInt($("#standard_quantity").val()) < 0.0){
				$("#standard_quantity").tips({
					side:3,
		            msg:'请输入正确的标准单数',
		            bg:'#AE81FF',
			...
			if($("#out_amount").val()==""){
				...
				$("#out_amount").focus();
			return false;
			}else if(Number($("#out_amount").val()) < 0.0){
				$("#out_amount").tips({
					side:3,
		            msg:'请输入正确的标准单数外金额',
		            bg:'#AE81FF',
