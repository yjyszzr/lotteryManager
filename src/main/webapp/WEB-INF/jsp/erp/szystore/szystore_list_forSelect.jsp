...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="szystore/listForSelect.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-mini btn-success" onclick="select('${var.store_sn}','${var.store_name}')">选择仓库</a>
												</div>
	...
	<script type="text/javascript">
		...
		function select(sn,name){
			top.frames[top.frames.length-2].closeSelectStoreDiag(sn,name);
		}
	</script>
</body>
</html>