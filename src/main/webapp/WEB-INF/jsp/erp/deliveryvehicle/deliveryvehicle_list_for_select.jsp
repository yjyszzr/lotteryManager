...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="deliveryvehicle/listForSelect.do" method="post" name="Form" id="Form">
						<table
									style="margin-top:5px;display:${pd.operType==1?'none':''}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">
												...
												<a class="btn btn-mini btn-success" onclick='top.colseDliveryVehicleWorkDiag("${var.delivery_vehicle_work_id }","${var.delivery_org_id}","${var.delivery_org_name}","${var.vehicle_number }","${var.contact }","${var.tel}")'>选择</a>
	...
	<script type="text/javascript">
		...
		function useLog(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="使用记录";
			 diag.URL = '<%=basePath%>deliveryvehicle/goUseLog.do';
			 diag.Width = 450;
			 diag.Height = 395;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
		...
		function file(Id){
			top.jzts();
			 ...
			 diag.Drag=true;
			 diag.Title ="文件记录";
			 diag.URL = '<%=basePath%>erpdeliveryvehicleworkfile/list.do';
			 diag.Width = 750;
			 diag.Height = 550;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
