...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="purchase/listForReport.do" method="post" name="Form" id="Form">
						<!-- 操作类型采购、审批等 -->
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class="center">
												...
												<a class="btn btn-xs btn-success" style = "margin-top:1px" onclick="toDetailList('${var.purchase_code}','${var.status }','${var.supplier_sn}');">
												
												
														明细详情
												</a>
												<a class="btn btn-xs btn-success" style = "margin-top:1px"  onclick="toPreNoticeList('${var.purchase_code}');">
														发货记录
												</a>
												<a class="btn btn-xs btn-success" style = "margin-top:1px"   onclick="'">
														退货记录
												</a>
	...
	<script type="text/javascript">
		...
		function toDetailList(purchase_code,status,supplier_sn){
		    ...
		    diag.URL = '<%=basePath%>purchasedetail/listForReport.do?purchase_code='+purchase_code+'&status='+status+'&supplier_sn='+supplier_sn;
		   if(${pd.bsType!=null}){
			 ...
			 diag.show();
				...
				//修改
		function toPreNoticeList(purchase_code){
			
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="发货记录";
		     diag.URL = '<%=basePath%>inboundprenotice/listForReport.do?purchase_code='+purchase_code;
