	...
	<script type="text/javascript">
		...
		//保存
		 function save(){
			...
			/* var org_id = "${purchase_group_id}";
			var org_name = "${purchase_group_name}"; */
			var url = "<%=basePath%>purchasegroup/savePurchaseGPUser.do";
			var postData;
			postData = {"purchase_group_id":"${purchase_group_id}","purchase_group_name":"${purchase_group_name}","userIds":ids};
			$("#zhongxin").hide();
			$("#zhongxin2").show();
