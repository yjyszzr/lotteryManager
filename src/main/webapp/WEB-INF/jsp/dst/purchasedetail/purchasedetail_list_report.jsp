					...
					<div class="row">
						...
						<table class="table table-striped table-bordered table-hover"  style="margin-top:15px;">
							...
							<tr>
								...
								<th class="center"><fmt:formatDate value="${pd.commit_time}" pattern="yyyy-MM-dd HH:mm:ss"/></th>
								<th class="center">审核人:</th>
								<th class="center">${pd.auditby}</th>
								<th class="center">审核时间:</th>
								<th class="center"><fmt:formatDate value="${pd.audit_time}" pattern="yyyy-MM-dd HH:mm:ss"/></th>
							</tr>
							<tr>
								<th class="center">采购组:</th>
								<th  style="text-align:left;word-wrap:break-word;word-break:break-all;"  colspan=7>${pd.purchase_group_name}</th>
							</tr>
							</table>
