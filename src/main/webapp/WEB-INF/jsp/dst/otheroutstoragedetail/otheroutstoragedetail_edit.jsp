		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="otheroutstoragedetail/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="other_outstorage_detail_id" id="other_outstorage_detail_id" value="${pd.other_outstorage_detail_id}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr style="display:none">
								<td style="width:75px;text-align: right;padding-top: 13px;">id:</td>
								<td><input type="number" name="other_outstorage_detail_id" id="other_outstorage_detail_id" value="${pd.other_outstorage_detail_id}" maxlength="32" placeholder="这里输入id" title="id" style="width:98%;"/></td>
							</tr>
							<tr >
								<td style="width:75px;text-align: right;padding-top: 13px;">出库编码:</td>
								<td><input type="text" name="other_outstorage_code" id="other_outstorage_code" value="${pd.other_outstorage_code}" maxlength="50" placeholder="这里输入出库编码" title="出库编码" style="width:98%;"/></td>
							</tr>
							<tr style="display:none">
							...
							<tr style="display:none">
								<td style="width:75px;text-align: right;padding-top: 13px;">sku编码:</td>
							...
							<tr style="display:none">
								...
								<td><input type="number" name="send_quantity" id="send_quantity" value="${pd.send_quantity}" maxlength="32" placeholder="这里输入发货数量" title="发货数量" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		//保存
		function save(){
			/* if($("#other_outstorage_detail_id").val()==""){
				$("#other_outstorage_detail_id").tips({
					side:3,
		            msg:'请输入id',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#other_outstorage_detail_id").focus();
			return false;
			}
