														...
														<div class="col-sm-5" style="width:100%;">
											                <div class="ibox float-e-margins">
											                    <div class="ibox-content" style="padding: 0px;">
											                        <form action="articleinfo/${msg }.do" name="Form" id="Form" method="post"  target="_self" class="form-horizontal m-t">
											                        	...
											                        	<div class="row" style="padding:5px">
											                                ...
											                                <input type="hidden"  id="article_info_id"   name ="article_info_id" value="${pd.id}"/>
