...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="appdoc/list.do" method="post" name="Form" id="Form">
	...
	<script type="text/javascript">
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>appdoc/deleteAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		function toPreShow(id){
			var url = "<%=basePath%>appdoc/toPreShow.do";
			$.ajax({
				  type: 'POST',
				  url: url,
				  data: {id:id},
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>appdoc/excel.do';
		}
	</script>
