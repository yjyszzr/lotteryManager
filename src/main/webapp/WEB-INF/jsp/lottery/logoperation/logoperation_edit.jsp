		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="logoperation/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="order_sn" id="order_sn" value="${pd.order_sn}" maxlength="80" placeholder="这里输入订单编号" title="订单编号" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="number" name="op_type" id="op_type" value="${pd.op_type}" maxlength="32" placeholder="这里输入操作类型" title="操作类型" style="width:98%;"/></td>
							</tr>
							<tr>
