				...
				<div class="page-content">
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								<td style="padding-left:2px;"><label>销售员账号:</label></label></td>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>${var.totalPersons}</td>
											<td class='center'>${var.curMoney}</td>
											<td class='center'>${var.totalMoney}</td>
											<td class='center'>${var.totalBonus}</td>
											<td class='center'><a onclick="toDetail('${var.userId}');" style=" cursor:pointer;">查看</td>
										</tr>
