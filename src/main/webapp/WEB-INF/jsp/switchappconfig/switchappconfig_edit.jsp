					...
					<form action="switchappconfig/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="platform" id="platform" value="${pd.platform}" maxlength="1" placeholder="这里输入平台:0-ios 1-android" title="平台" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">业务版本</td>
								<td><input type="text" name="business_type" id="business_type" value="${pd.business_type}" maxlength="255" placeholder="这里输入业务版本:1-交易版 2-资讯版" title="业务版本" style="width:98%;"/></td>
							</tr>
							<tr>
