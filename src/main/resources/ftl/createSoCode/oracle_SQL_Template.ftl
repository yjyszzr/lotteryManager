...
<#list fieldList as var>
	...
	"${primaryKey}_id" VARCHAR2(100 BYTE) NOT NULL,
...
COMMENT ON COLUMN "C##FHADMIN"."${tabletop}${objectNameUpper}"."${primaryKey}_id" IS 'ID';
...
ALTER TABLE "C##FHADMIN"."${tabletop}${objectNameUpper}" ADD CHECK ("${primaryKey}_id" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table "C##FHADMIN"."${tabletop}${objectNameUpper}"
-- ----------------------------
ALTER TABLE "C##FHADMIN"."${tabletop}${objectNameUpper}" ADD PRIMARY KEY ("${primaryKey}_id");
