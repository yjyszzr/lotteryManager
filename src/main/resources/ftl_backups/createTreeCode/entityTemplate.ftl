...
public class ${objectName}{ 
	...
	private String ${primaryKey}_id;	//主键
	...
	public String get${primaryKey}_id() {
		return ${primaryKey}_id;
	}
	public void set${primaryKey}_id(String ${primaryKey}_id) {
		this.${primaryKey}_id = ${primaryKey}_id;
	}
