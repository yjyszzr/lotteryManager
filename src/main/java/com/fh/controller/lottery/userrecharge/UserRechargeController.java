	...
	public ModelAndView exportExcel() throws Exception {
		...
		if (varOList.size() > 0) {
    		...
    		for (int i = 0; i < varOList.size(); i++) {
    			...
    			vpd.put("var6", StringUtil.isEmptyStr(useraccountMap.get(varOList.get(i).getString("recharge_sn"))) ? "0元" : useraccountMap.get(varOList.get(i).getString("recharge_sn")) + "元"); // 6
