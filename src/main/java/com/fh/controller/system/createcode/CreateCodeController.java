...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		String primaryKey = pd.getString("primaryKey");	   			//表前缀				========参数4
		String primaryType = pd.getString("primaryType");	   		//表前缀				========参数5
		String tableName = pd.getString("tableName");	   		    //表前缀				========参数6
...
//		root.put("objectNameUpper", objectName.toUpperCase());		//类名(全大写)
		root.put("primaryKey", primaryKey.toLowerCase());		    //主键
		root.put("primaryType", primaryType.toLowerCase());		    //主键类型
...
//		pd.put("TABLENAME", pd.getString("tabletop")+",fh,"+pd.getString("objectName").toUpperCase());	//表名
		pd.put("TABLENAME", pd.getString("tabletop")+",fh,"+pd.getString("tableName").toLowerCase());	//表名
		pd.put("FIELDLIST", pd.getString("FIELDLIST"));		//属性集合
		pd.put("PRIMARYKEY", pd.getString("primaryKey"));	//主键
		pd.put("PRIMARYTYPE", pd.getString("primaryType"));	//主键类型
