package com.fh.controller.outboundstockbatch;
 ...
 */
@Controller
@RequestMapping(value="/outboundstockbatch")
public class OutboundStockBatchController extends BaseController {
	
	String menuUrl = "outboundstockbatch/list.do"; //菜单地址(权限用)
...
//		pd.put("inbound_stock_batch_id", this.get32UUID());	//主键
		outboundstockbatchService.save(pd);
	...
	public void delete(PrintWriter out) throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		outboundstockbatchService.delete(pd);
		out.write("success");
		out.close();
	}
	...
	public ModelAndView edit() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		outboundstockbatchService.edit(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView list(Page page) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varList = outboundstockbatchService.listAll(pd);	//列出InboundStockBatch列表
		mv.setViewName("erp/outboundstockbatch/outboundstockbatch_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/outboundstockbatch/outboundstockbatch_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = outboundstockbatchService.findById(pd);	//根据ID读取
		mv.setViewName("system/outboundstockbatch/outboundstockbatch_edit");
	...
	public Object deleteAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			outboundstockbatchService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
	...
	public ModelAndView printbatchPage()throws Exception{
		...
		mv.setViewName("erp/outboundstockbatch/printbatchpage");
		mv.addObject("msg", "edit");
		mv.addObject("pd", pd);
	...
	public ModelAndView exportExcel() throws Exception{
		...
		List<PageData> varOList = outboundstockbatchService.listAll(pd);
