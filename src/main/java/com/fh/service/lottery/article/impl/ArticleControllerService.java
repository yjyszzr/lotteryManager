...
public class ArticleControllerService implements ArticleControllerManager{
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("ArticleControllerMapper.datalistPage", page);
	}
	...
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("ArticleControllerMapper.listAll", pd);
	}
	...
	public PageData findById(PageData pd)throws Exception{
		return (PageData)dao.findForObject("ArticleControllerMapper.findById", pd);
	}
